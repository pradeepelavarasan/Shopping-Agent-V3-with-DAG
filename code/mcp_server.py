...
async def playwright_fetch(url: str) -> str:
    """Stealthily fetches a URL page content using Playwright to evade anti-bot checks. Example: playwright_fetch(\"https://www.amazon.in/s?k=badminton+rackets\")."""
    from scraper import playwright_fetch as _pw_fetch
